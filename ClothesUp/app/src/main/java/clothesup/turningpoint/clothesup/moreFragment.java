...
public class moreFragment extends Fragment implements View.OnClickListener{
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstance) {
        ...
        initView(view);     // get Views ID and set on click listener
        return view;
    }
    ...
    public void onClick(View v) {
        switch(v.getId()){
            ...
            case R.id.notice_imageView :
                Log.d("onClick!!", "hi");
                Intent intentNotice = new Intent(this.getContext(), NoticeTextActivity.class);
...
/*
            ...
            case R.id.guide_imageView :
                Log.d("onClick!!", "hi");
                Intent intentGuide = new Intent(this.getContext(), )
*/
